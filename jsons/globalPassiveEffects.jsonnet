    ...
    "automation": {
        "cards": {
            ...
            "4823aae3-46ef-4a75-89f9-cbd3aa1b9008": globalPassiveEffect(
                ...
                conditionOnLog = "Added 1 attack to each Gondor ally in play.",
                conditionOffLog = "Removed 1 attack from each Gondor ally in play.",
            ...
            "2f0a3f18-c84f-4458-b6f7-2e6be9acee6b": globalPassiveEffect(
                ...
                conditionOnLog = "Added 1 willpower to each Gondor character in play.",
                conditionOffLog = "Removed 1 willpower from each Gondor character in play.",
            ...
            "d5f09d24-be50-4958-b0d0-41b1ad09b7af": globalPassiveEffect(
                ...
                effectOn = addToken("willpower"),
                effectOff = removeToken("willpower"),
                conditionOnLog = "Added 1 willpower to each hero in play.",
                conditionOffLog = "Removed 1 willpower from each hero in play.",
            ...
            // TODO Elfhelm, Brand son of Bain, Banner of Elendil
