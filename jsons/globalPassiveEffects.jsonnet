    ...
    "automation": {
        "cards": {
            ...
            "d5f09d24-be50-4958-b0d0-41b1ad09b7af": globalPassiveEffect(
                ...
                listenToThisChange = ["/cardById/$THIS_ID/cardIndex"],
                thisCondition = [["GREATER_THAN", "$THIS.cardIndex", 0]],
                listenToTargetChange = ["/cardById/*/sides/*/type", "/cardById/*/controller"],
                targetCondition = [["EQUAL", "$THIS.controller", "$TARGET.controller"], ["IS_CHARACTER", "$TARGET"]],
                effectOn = addToken("willpower") + addToken("attack") + addToken("defense"),
                effectOff = removeToken("willpower") + removeToken("attack") + removeToken("defense"),
                conditionOnLog = "Added 1 willpower, 1 attack, and 1 defense to each character.",
                conditionOffLog = "Removed 1 willpower, 1 attack, and 1 defense from each character.",
                targetOnLog = "Fellowship of the Ring added 1 willpower, 1 attack, and 1 defense to ",
            ),
